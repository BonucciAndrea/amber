...
#     h-1  box bottom   ╰────────────────────────────────╯
#      h   info line    ⬡ amber 2.1.0 · exec · mem · [native|portable] …
...
check("⬡ amber 2.1.0".encode() in txt,             "truecolor hex logo + brand on the info line")
...
try:
    ...
    check("⬡ amber 2.1.0" in disp[23], "[pyte] info line on the last row")
    ...
    pump(0.2)
    check("⬡ amber 2.1.0" in screen.display[23], "[pyte] wheel-down restores the normal info line")
